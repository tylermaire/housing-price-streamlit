...
# 1) Load & cache the Redfin metro data
@st.cache_data
def load_data():
    try:
...
# 4) Compute features for prediction
...
# 5) Load model from GitHub raw, fixing the “metro area” suffix
@st.cache_resource
